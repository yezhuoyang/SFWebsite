...
From Coq Require Import Setoid.  (* Generalized rewriting *)
From Coq Require Import FSets.   (* Efficient functional sets *)
From Coq Require Import FMaps.   (* Efficient functional maps *)
From Coq Require Import PArith.  (* Positives *)
...
From Coq Require Import Recdef.  (* Must import this to use the [Function] feature *)
