...
export default function SolutionsModal({ exerciseId, exerciseName, currentCode, getLatestCode, onClose }: Props) {
  ...
  // Belt-and-braces: capture the Monaco editor instance and forcibly setValue
  // on mount. `defaultValue`/`value` props can race with the lazy Monaco
  // loader and leave the editor blank; setValue after mount can't be missed.
